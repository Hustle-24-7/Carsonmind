...
from model.CarsonModel import CarsonMindConfig, CarsonMindForCausalLM  # MiniMind模型
...
class CriticModel(CarsonMindForCausalLM):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="CarsonMind PPO (Proximal Policy Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="CarsonMind-PPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"CarsonMind-PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
