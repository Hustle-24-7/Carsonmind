...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="CarsonMind GRPO (Group Relative Policy Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="CarsonMind-GRPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"CarsonMind-GRPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
