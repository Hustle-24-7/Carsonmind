...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CarsonMind Full SFT")
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="CarsonMind-Full-SFT", help="wandb项目名"
    )
    parser.add_argument(
        "--use_compile",
        default=0,
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"CarsonMind-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
