...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="CarsonMind DPO (Direct Preference Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="CarsonMind-DPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"CarsonMind-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
